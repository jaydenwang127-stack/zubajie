...
- `data/reviews.json`: 16 hand-picked Google Maps reviews (the contact page shows the first 8 as a Google-style widget; `reviews.html` only redirects there) (harvested 2026-09-12, 60 of 125 read) with our translations. Quoted verbatim; never edit a customer's words. Rating/count are as Google showed that day — refresh them when rebuilding months later.
